...
Description
    ...
    utilized.
    Set up as a conjugate heat transfer solver with heat transfer between fluid
    and solid parts at non-conformal patches.
...
#       include "readStressedFoamControls.H"
        ...
        // rotate the fluid and solid mesh about the axis
        mesh.update();
        stressMesh.update();
